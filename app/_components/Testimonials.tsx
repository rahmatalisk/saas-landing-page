  ...
  return (
    <section className="bg-white ">
      <div className="container">
        <div className="tag w-fit mx-auto block">Testimonial</div>
        <h2 className="section-title my-5">What our users say</h2>
        <p className="section-description mb-10">
          From intuitive design to poerful features, our app has become an
